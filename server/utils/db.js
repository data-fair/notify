...
exports.init = async () => {
  ...
  await exports.ensureIndex(db, 'subscriptions', { outputs: 1 }, { name: 'digests-job' })
  await exports.ensureIndex(db, 'notifications', { 'recipient.id': 1, date: -1, 'topic.key': 1 }, { name: 'main-keys' })
